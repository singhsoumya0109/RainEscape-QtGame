...
MainWindow::MainWindow(QWidget *parent)
    ...
    // Create the umbrella
    umbrella = new Umbrella(350, 550, 70, 20,this);
    ...
    spawnTimer->start(500); // Spawn a raindrop every second

    gameTimer = new QTimer(this);
    connect(gameTimer, &QTimer::timeout, this, &MainWindow::updateGame);
    gameTimer->start(100); // Update game state every 50 ms
}
...
void MainWindow::updateGame() {
    ...
    for (int i = 0; i < raindrops.size(); ++i) {
        ...
        raindrop->moveDown(30); // Move the raindrop down by 5 units
...
void MainWindow::keyPressEvent(QKeyEvent *event) {
    ...
    int distance = 10; // Distance the umbrella moves
